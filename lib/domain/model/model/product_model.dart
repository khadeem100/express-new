...
class Brand {
  Brand({int? id, String? uuid, String? img, String? title}) {
    _id = id;
    _uuid = uuid;
    _img = img;
    _title = title;
  ...
  Brand copyWith({int? id, String? uuid, String? img, String? title}) => Brand(
    id: id ?? _id,
    uuid: uuid ?? _uuid,
    img: img ?? _img,
    title: title ?? _title,
...
class Extras {
  Extras({int? id, int? extraGroupId, String? value, GroupProperties? group}) {
    _id = id;
...
class WholePriceResponse {
  ...
  WholePriceResponse({this.id, this.minQuantity, this.maxQuantity, this.price});
  ...
  factory WholePriceResponse.fromJson(Map<String, dynamic> json) =>
      WholePriceResponse(
        id: json["id"],
...
class PropertiesGroup {
  ...
  PropertiesGroup({this.id, this.type, this.active, this.translation});
...
class Value {
  ...
  Value({this.id, this.value, this.active});

  Value copyWith({int? id, String? value, bool? active}) => Value(
    id: id ?? this.id,
    value: value ?? this.value,
    active: active ?? this.active,
  );
  ...
  factory Value.fromJson(Map<String, dynamic> json) =>
      Value(id: json["id"], value: json["value"], active: json["active"]);

  Map<String, dynamic> toJson() => {"id": id, "value": value, "active": active};
}
